      ...
      <div class="update">
          ...
          <form action="#" method="post">
				...
				<div id="bottomText">
					...
					<div class="text02"><router-link class="text_right" to="/updatepwd/mail">邮箱找回</router-link></div>
				</div>
                <div class="clear"></div>
  ...
  methods: {
    sendMobileSms(){
      if(this.mobile.length != 11){
        ...
        let that=this;
        this.axios.post('https://grouponapi.top/api/auth/resetpassword/phone/send',{
          phone: this.mobile
        }).then(res => {
          that.$message({
            message: '发送成功',
    ...
    updatePwd(){
      if(this.mobile == '' || this.mobile.length != 11){
        ...
        let that=this;
        this.axios.patch('https://grouponapi.top/api/auth/resetpassword/phone',{
          phone: this.mobile,
          code: this.code,
