      ...
      <div class="register" v-show="true">
          ...
          <form action="#" method="post">
                ...
                <div class="i">
                    ...
                    <input type="text" v-model="mobile" name="" id="mobile" placeholder="手机号" required="required" autocomplete="off" />
                </div>
                <div class="check_Code">
                    ...
                    <button type="button" v-on:click="sendMobileSms()" v-bind:disabled="disabled">{{ send_code }}{{ s }}</button>
			          ...
			          <input type="password" v-model="password1" name="" class="pwd" placeholder="密码（长度至少8位）" required="required" autocomplete="off" /><br>
                ...
                <div id="bottomText">
                  ...
                  <div class="text02"><router-link class="text_right" to="/register/mail">邮箱注册</router-link></div>
                </div>
                <div class="clear"></div>
  ...
  methods: {
    sendMobileSms(){
      if(this.mobile.length != 11){
        ...
        let that=this;
        this.axios.post('https://grouponapi.top/api/auth/register/phone/send',{
          phone: this.mobile
        }).then(res => {
          that.$message({
            message: '发送成功',
    ...
    register(){
      if(this.username == ''){
        ...
        let that=this;
        this.axios.post('https://grouponapi.top/api/auth/register/phone',{
